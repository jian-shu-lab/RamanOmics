...
# Data Available
All the data used in this study including scRNA-seq, spatial transcriptomics, and Raman Imaging data, are being uploaded to the SenNet Consortium (https://sennetconsortium.org/data-previews/) and are under review, which will be publicly available soon.
