...
class StarMapTile(FetchedTile):
    ...
    def shape(self) -> Mapping[Axes, int]:
        return {Axes.Y: 2048, Axes.X: 2048} 
...
class StarMapTileFetcher(TileFetcher):
    ...
    def get_tile(
        ...
        basename = f"mLung_O1_R{round_label + 1}_ch0{ch_label + 1}.tif" 
    ...
    def generate_codebook(self, output_dir: str) -> None:
        ...
        ----------
        output_dir : str
            directory in which to save the generated codebook. Codebook is saved as "codebook.json" #NEVER CHANGE
